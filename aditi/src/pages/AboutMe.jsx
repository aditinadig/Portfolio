      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="space-y-4">
          <h1 className="text-5xl md:text-5xl font-extrabold tracking-tight leading-tight">
            I don’t ship it{" "}
            <span className="inline-block bg-[#B477ED]/20 px-3 py-1 rounded-xl">
          ...
          <p className="text-xl md:text-xl leading-relaxed">
            ...
            <span className="underline decoration-[#ffca13] underline-offset-4">
              1px misalignment
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-4">
            ...
            <div className="p-6 rounded-2xl bg-[#fff8e3] shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md hover:-translate-y-[2px]">
              <h3 className="text-lg font-semibold tracking-wide text-[#2b2a2a] mb-2">
        ...
        {/* Signature */}
        <div className="max-w-4xl text-xl md:text-xl italic border-l-4 border-[#B477ED] pl-6 leading-relaxed text-[#2b2a2a]/80">
          If your product needs to{" "}
          <span className="not-italic font-bold text-[#B477ED]">feel</span> just
