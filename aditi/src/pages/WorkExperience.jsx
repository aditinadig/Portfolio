        ...
        <div className="relative pl-4 md:pl-4 before:absolute before:left-4 md:before:left-6 before:top-0 before:h-full before:w-[2px] before:bg-ink/20">
          {experience.map((job, index) => (
            <div key={index} className="relative mb-6 group">
              ...
              {/* Card */}
              <div className="ml-8 md:ml-12 bg-white rounded-3xl shadow-sm p-6 md:p-8 hover:shadow-lg transition-all duration-300">
                {/* Header */}
                <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
                  <h3 className="text-xl md:text-2xl font-semibold">
                    {job.title}{" "}
                    <span className="text-lilac font-normal">@ {job.company}</span>
                  </h3>
                  <div className="text-sm text-ink/60 mt-1 md:mt-0 font-medium">
